...
namespace UFT
{
    ...
    bool RegisterFunctions(VMClassRegistry* registry)
    {
        registry->RegisterFunction(
            new NativeFunction1<StaticFunctionTag, bool, SInt32>("HasOverride", "UnrestrictedFastTravel", PP_HasOverride, registry));
        registry->RegisterFunction(
            new NativeFunction2<StaticFunctionTag, void, SInt32, bool>("SetOverride", "UnrestrictedFastTravel", PP_SetOverride, registry));
        registry->RegisterFunction(
            new NativeFunction0<StaticFunctionTag, UInt32>("GetVersion", "UnrestrictedFastTravel", PP_GetVersion, registry));
